...
export const DFC1 = () => {
  ...
  return (
    <div className="p-3 sm:p-5">
      {/* Pending Tasks */}
      <div>
        <h2 className="text-md lg:text-lg font-bold mb-3">Pending Tasks:</h2>
      ...
      {/* Tasks in Progress */}
      <div className="mt-10">
        <h2 className="text-md lg:text-lg font-bold mb-3">
          Tasks in Progress:
        </h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
      ...
      {/* Completed Tasks */}
      <div className="mt-10">
        <h2 className="text-md lg:text-lg font-bold mb-3">Completed Tasks:</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
